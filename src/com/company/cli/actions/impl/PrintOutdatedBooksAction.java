...
public class PrintOutdatedBooksAction implements Action {
    Facade facade;

    BookComparator.By by;

    public PrintOutdatedBooksAction(Facade facade, BookComparator.By by){
        this.facade = facade;
        this.by = by;
    }
    ...
    public void execute(){
        ...
        if (by == null)
            books = facade.getOutdatedBooks();
        else
            books = facade.getOutdatedBooks(by);
